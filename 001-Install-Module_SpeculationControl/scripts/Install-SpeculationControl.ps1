...
Stop-Service -Name 'WindowsAzureGuestAgent' -Force -WarningAction SilentlyContinue -ErrorAction  SilentlyContinue | Out-Null
Start-Service -Name 'WindowsAzureGuestAgent' -Force -WarningAction SilentlyContinue -ErrorAction SilentlyContinue | Out-Null
